...
mv star_wars/empire/death_star/chewbacca.txt mv star_wars/empire/death_star/han_solo.txt
mv star_wars/empire/death_star/princess_leia.txt mv star_wars/empire/death_star/luke_skywalker.txt
...
mv star_wars/empire/death_star/darth_vador.txt star_wars/empire
