...
echo "Help me, obi-Wan...You're my only hope." > touch star_wars/rebellion/princess_leia.txt
...
mv princess_leia.txt mellenium_falcon
mv luke_skywalker.tx mellenium_falcon
mv obi_wan.tx mellenium_falcon
