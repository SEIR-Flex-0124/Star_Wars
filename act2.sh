...
First I executed a mv millenium_falcom ../ to remove it from rebellion folder. Then i cd'd back into the star_wars folder and entered the command mv millenium_falcon death_star.
