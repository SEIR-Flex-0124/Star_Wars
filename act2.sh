...
touch rebellion/princess_leia.txt && echo "Help me, Obi-Wan...You're my only hope."
...
mkdir rebellion/millemium_falcon
# 5. Inside the millenium_falcon, create two files: han_solo.txt and chewbacca.txt
touch rebellion/millenium_falcon/han_solo.txt && touch rebellion/millenium_falcon/chewbacca.txt
