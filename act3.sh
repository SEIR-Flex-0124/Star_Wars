...
mv ~/Star_Wars/star_wars/empire/death_star/mi
llenium_falcon/*.txt ~/Star_Wars/star_wars/empire/death_star
...
mv chewbacca.txt han_solo.txt luke_skywalker.txt pr
incess_leia.txt ~/Star_Wars/star_wars/empire/death_star/millenium_falcon
...
mv ~/Star_Wars/star_wars/empire/death_star/da
rth_vader.txt ~/Star_Wars/star_wars/empire
