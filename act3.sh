...
mv star_wars/empire/death_star/millenium_falcon/*txt star_wars/empire/death_star #was trying to mv from within deathstar but kept getting "is not a directory", works from main directory though 
# 2. darth_vader has defeated obi_wan! Delete poor obi_wan.
rm star_wars/empire/obi_wan.txt #irrational fear of rm the entire directory so I cd'ed as close as I could 
...
mv chewbacca.txt han_solo.txt luke_skywalker.txt princess_leia #
