...
touch star_wars/rebellion/millenium_falcon/han_solo.txt chewbacca.txt #tested out && here to see if i'd have to specify 'touch' twice...i did indeed need to, better without &&
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
mv star_wars/rebellion/luke_skywalker.txt obi_wan.txt princess_leia.txt -t star_wars/rebellion/millenium_falcon
