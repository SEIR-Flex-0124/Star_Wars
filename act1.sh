...
mv star_wars/rebellion/darth_vader.txt star_wars/empire/death_star #tab autocompleted mv to 'Move' and I wanted to try it out. I guess it was refrencing "Move" since it was typed out in the instructions before