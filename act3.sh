...
mv chewbacca.txt han_solo.txt luke_skywalker.txt princess_leia.txt ~/ millenium_falcon //I received an error (Operation not permitted, but it did move my files?)
