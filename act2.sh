...
touch rebellion/princess_leia.txt && echo "Help me, Obi-Wan…You’re my only hope." star_wars/rebellion/princess_leia 
...
mv obi_wan.txt millenium_falcon && mv princess_leia.txt millenium_falcon 
